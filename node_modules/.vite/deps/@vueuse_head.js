...
var tagToString = (tag) => {
  ...
  let innerContent = "";
  if (((_a2 = tag._options) == null ? void 0 : _a2.raw) && tag.props.innerHTML)
  ...
  for (const tag of head.headTags.sort(sortTags)) {
    if (tag.tag === "title") {
      ...
      for (const k in tag.props) {
        ...
        attrs[tag.tag][keyName] = ((_a2 = tag._options) == null ? void 0 : _a2.raw) ? tag.props[keyName] : tag.props[stringifyAttrValue(keyName)];
      }
    ...
    get headTags() {
      ...
      resolvedHeadObjs.forEach((objs, headObjectIdx) => {
        ...
        tags2.forEach((tag, tagIdx) => {
          ...
          if (!((_a2 = tag._options) == null ? void 0 : _a2.raw)) {
            for (const k in tag.props) {
              if (k.startsWith("on")) {

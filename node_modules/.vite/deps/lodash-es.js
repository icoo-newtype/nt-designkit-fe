...
var propertyIsEnumerable = objectProto10.propertyIsEnumerable;
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto15[key]) && !hasOwnProperty14.call(object, key)) {
...
var invertBy = createInverter_default(function(result2, value, key) {
  ...
  if (hasOwnProperty17.call(result2, value)) {
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto20[key]) && !hasOwnProperty18.call(object, key)) {
    return srcValue;
  }
  return objValue;
}

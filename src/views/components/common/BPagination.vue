...
<template>
  <ul class="pagination b-pagination">
    <li class="page-item" :class="{ disabled: paging.pageNo === 1 }" @click="$emit('changePage', 1)"><span class="page-link"><img src="/admin/img/first-arrow.png" class="w-20" alt="<<"></span></li>
    <li class="page-item" :class="{ disabled: paging.pageNo === 1 }" @click="$emit('changePage', paging.pageNo - 1)"><span class="page-link"><img src="/admin/img/prev-arrow.png" class="w-20" alt="<"></span></li>
    ...
    <li class="page-item" :class="{ disabled: paging.pageNo === totalPage }" @click="$emit('changePage', paging.pageNo + 1)"><span class="page-link"><img src="/admin/img/next-arrow.png" class="w-20" alt=">"></span></li>
    <li class="page-item" :class="{ disabled: paging.pageNo === totalPage }" @click="$emit('changePage', totalPage)"><span class="page-link"><img src="/admin/img/last-arrow.png" class="w-20" alt=">>"></span></li>
  </ul>
</template>
<style lang="less">
@import "@/less/proj";
